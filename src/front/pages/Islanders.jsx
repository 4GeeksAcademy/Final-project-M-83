        ...
        <div className="islanders">
            ...
            {femaleContestants.length > 0 && (
                <section className="islander-section girls-section">
                    ...
                    <ContestantGrid list={femaleContestants} gender="female" onFavorite={userFavorite} displayBio={true} showFavoriteButton={true}/>
                    </div>
                </section>
            )}
            ...
            {maleContestants.length > 0 && (
                <section className="islander-section guys-section">
                    ...
                    <div className="scrollable-bio-container">
                        <ContestantGrid list={maleContestants} gender="male" onFavorite={userFavorite} displayBio={true} showFavoriteButton={true}/>
                    </div>
                </section>
            )}
        </div>
